...
interface OperatorProfileEditPageProps extends PageProps {
    user: User;
    flash?: {
        success?: {
            title: string;
...
export default function EditOperatorProfile() {
    const { user, errors } = usePage<OperatorProfileEditPageProps>().props;
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Debug log
        console.log('Submitting operator profile with data:', {
            ...data,
        ...
        post('/operator/profile', {
            ...
            onSuccess: () => {
                console.log('Operator profile updated successfully');
            },
            onError: (errors) => {
                console.log('Operator profile validation errors:', errors);
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Profile - Operator" />
                    ...
                    <Card className="lg:col-span-2">
                        ...
                        <CardContent>
                            <div className="space-y-4 md:space-y-6">
                                ...
                                <div className="space-y-3 md:space-y-4">
                                    <div>
                                        <h3 className="text-sm font-medium md:text-base">Bank Information</h3>
                                        <p className="text-xs text-muted-foreground md:text-sm">Bank details for payment purposes</p>
                                    </div>

                                    <div className="space-y-3 md:space-y-4">
                                        <div className="space-y-2">
                                            <Label htmlFor="bank_name" className="text-xs font-medium md:text-sm">
                                                Bank Name
                                            </Label>
                                            <Input
                                                id="bank_name"
                                                ...
                                                className={cn(errors.bank_name && 'border-red-500', 'text-xs md:text-sm')}
                                        ...
                                        <div className="grid gap-3 sm:grid-cols-2 md:gap-4">
                                            <div className="space-y-2">
                                                <Label htmlFor="bank_account_number" className="text-xs font-medium md:text-sm">
                                                    Account Number
                                                </Label>
                                                <Input
                                                    ...
                                                    className={cn(errors.bank_account_number && 'border-red-500', 'text-xs md:text-sm')}
                                            ...
                                            <div className="space-y-2">
                                                <Label htmlFor="bank_account_holder" className="text-xs font-medium md:text-sm">
                                                    Account Holder Name
                                                </Label>
                                                <Input
                                                    ...
                                                    className={cn(errors.bank_account_holder && 'border-red-500', 'text-xs md:text-sm')}
                                                    placeholder="Enter account holder name"
                                                />
                                                {errors.bank_account_holder && <p className="text-xs text-red-500">{errors.bank_account_holder}</p>}
                                            </div>
                                        </div>
                                    </div>
                                </div>
