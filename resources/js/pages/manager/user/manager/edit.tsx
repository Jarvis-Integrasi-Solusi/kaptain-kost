...
interface ManagerEditPageProps extends PageProps {
    manager: Manager;
    flash?: {
        success?: {
            title: string;
...
export default function EditManager() {
    const { manager, errors } = usePage<ManagerEditPageProps>().props;
    ...
    // Set initial preview image if manager has existing image
    useEffect(() => {
        if (manager.image && !removeExistingImage) {
            setPreviewImage(`/storage/${manager.image}`);
        } else {
            setPreviewImage(null);
        }
    }, [manager.image, removeExistingImage]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(`/manager/user/manager/${manager.id}`, {
            onSuccess: () => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Manager - ${manager.name}`} />

            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">Edit Manager</h1>
                        <p className="text-muted-foreground">Update manager account information</p>
                    </div>
                </div>
                ...
                <div className="grid gap-6 lg:grid-cols-3 lg:items-start">
                    ...
                    <Card className="lg:col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>Update the manager account details</CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="self-start lg:col-span-1">
                        <CardHeader>
                            ...
                            <CardDescription>Update profile image for the manager</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-2">
                                {previewImage ? (
