...
interface ManagerCreatePageProps extends PageProps {
    flash?: {
        success?: {
            title: string;
            message: string;
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create',
        href: '/manager/user/manager/create',
    },
];

export default function CreateManager() {
    const { errors } = usePage<ManagerCreatePageProps>().props;
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Add a new manager account</p>
                    </div>
                </div>
                ...
                <div className="grid gap-6 lg:grid-cols-3 lg:items-start">
                    ...
                    <Card className="lg:col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>Enter the manager account details</CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="self-start lg:col-span-1">
                        <CardHeader>
                            ...
                            <CardDescription>Upload a profile image for the manager</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-2">
                                {previewImage ? (
