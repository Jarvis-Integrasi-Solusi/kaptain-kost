...
export default function EditTenant() {
    const { tenant, errors } = usePage<TenantEditPageProps>().props;
    ...
    const { data, setData, post, processing } = useForm({
        ...
        guardian_telephone: tenant.guardian_telephone || '',
        password: '',
    ...
    // Set initial preview image if tenant has existing image
    useEffect(() => {
        if (tenant.image) {
            setPreviewImage(`/storage/${tenant.image}`);
        }
    }, [tenant.image]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(`/manager/user/tenant/${tenant.id}`, {
            onSuccess: () => {
    ...
    const handleCancel = () => {
        router.get('/manager/user/tenant');
    };
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Update tenant information and details</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-3 lg:items-start">
                    ...
                    <Card className="lg:col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>Update the tenant details and personal information</CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="self-start lg:col-span-1">
                        <CardHeader>
                            ...
                            <CardDescription>Upload a profile image for this tenant</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-2">
                                {previewImage ? (
