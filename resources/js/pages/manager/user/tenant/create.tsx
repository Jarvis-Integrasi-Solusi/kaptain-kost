...
interface TenantCreatePageProps extends PageProps {
    flash?: {
        success?: {
            title: string;
            message: string;
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create',
        href: '/manager/user/tenant/create',
    },
];

export default function CreateTenant() {
    const { errors } = usePage<TenantCreatePageProps>().props;
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Add a new tenant account</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-3 lg:items-start">
                    ...
                    <Card className="lg:col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>Enter the tenant account details</CardDescription>
                        </CardHeader>
                        <CardContent>
