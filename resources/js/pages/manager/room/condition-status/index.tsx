...
export default function ConditionStatusList() {
    const { condition_statuses, filters } = usePage<ConditionStatusPageProps>().props;
    ...
    const [editingStatus, setEditingStatus] = useState<ConditionStatus | null>(null);
    ...
    const { paginatedData, totalPages, totalItems } = useMemo(() => {
        ...
        const filtered = condition_statuses.filter((status) => {
    ...
    }, [condition_statuses, search, currentPage, itemsPerPage]);
    ...
    const handleCreate = (e: React.FormEvent) => {
        e.preventDefault();
        createForm.post('/manager/room/condition-status', {
            onSuccess: () => {
    ...
    const handleEdit = (e: React.FormEvent) => {
        ...
        editForm.put(`/manager/room/condition-status/${editingStatus.id}`, {
            onSuccess: () => {
    ...
    const handleDelete = async (id: number) => {
        setIsDeleting(true);
        router.delete(`/manager/room/condition-status/${id}`, {
            onSuccess: () => {
                setDeleteId(null);
            },
            onFinish: () => {
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                <CardTitle className="text-xl">Condition Status</CardTitle>
                                <CardDescription>
                                    Manage room condition status options
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    <form onSubmit={handleCreate}>
                        <DialogHeader>
                            <DialogTitle>Add New Condition Status</DialogTitle>
                        </DialogHeader>
            ...
            <Dialog open={!!editingStatus} onOpenChange={() => setEditingStatus(null)}>
                <DialogContent className="sm:max-w-[425px]">
                    <form onSubmit={handleEdit}>
                        <DialogHeader>
                            <DialogTitle>Edit Condition Status</DialogTitle>
                        </DialogHeader>
                        <div className="grid gap-4 py-4">
                            <div className="grid gap-2">
            ...
            <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>This will permanently delete the condition status.</AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
