...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: '/manager/rental/periods',
    },
];

export default function RentalPeriodList() {
    const { rental_periods, filters } = usePage<RentalPeriodPageProps>().props;
    ...
    const { paginatedData, totalPages, totalItems } = useMemo(() => {
        ...
        const filtered = rental_periods.filter((status) => {
    ...
    }, [rental_periods, search, currentPage, itemsPerPage]);
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                <CardTitle className="text-xl">Rental Period</CardTitle>
                                <CardDescription>
                                    Manage rental period options
                                    ...
                                    {paginatedData.length === 0 ? (
                                        <TableRow>
                                            <TableCell colSpan={2} className="h-24 text-center">
                                                {search ? `No period found matching "${search}".` : 'No period found.'}
                                            </TableCell>
                                        </TableRow>
                                    ) : (
                                                    ...
                                                    <DropdownMenu>
                                                        ...
                                                        <DropdownMenuContent align="end">
                                                            <DropdownMenuItem asChild>
                                                                <Link href={`/manager/rental/period/${period.id}`}>
