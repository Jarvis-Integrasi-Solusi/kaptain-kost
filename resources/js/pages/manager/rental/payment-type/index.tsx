...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Payment Types',
        href: '/manager/rental/payment-types',
    },
];

export default function PaymentTypeList() {
    const { payment_types, filters } = usePage<PaymentTypePageProps>().props;
    ...
    const { paginatedData, totalPages, totalItems } = useMemo(() => {
        ...
        const filtered = payment_types.filter((type) => {
    ...
    }, [payment_types, search, currentPage, itemsPerPage]);
                                                    ...
                                                    <DropdownMenu>
                                                        ...
                                                        <DropdownMenuContent align="end">
                                                            <DropdownMenuItem asChild>
                                                                <Link href={`/manager/rental/payment-type/${type.id}`}>
